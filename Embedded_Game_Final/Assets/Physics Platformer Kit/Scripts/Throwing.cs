...
[RequireComponent(typeof(PlayerMovezzy))]
public class Throwing : MonoBehaviour 
{
	...
	private PlayerMovezzy playerMove;
	...
	void Awake()
	{
		...
		playerMove = GetComponent<PlayerMovezzy>();
	...
	void Update()
	{
		...
		if ((Input.GetButtonDown ("Grab")||GetComponent<PlayerMovezzy>().catchButton.PressDown) && heldObj && Time.time > timeOfPickup + 0.1f)
		{
